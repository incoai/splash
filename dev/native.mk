...
TEST_ACCEPT_ORACLE_TEST := $(ENGINE_TEST_BUILD)/accept-oracle
...
$(TEST_ACCEPT_ORACLE_TEST): dev/tests/engine/accept_oracle_metal_test.mm \
		$(ENGINE_LIBRARY) $(LIB) | $(ENGINE_TEST_BUILD)
	$(RUN_CONFIGURED) $(CXX) $(ENGINE_TEST_CXXFLAGS) -fobjc-arc $< $(ENGINE_LIBRARY) \
		$(ENGINE_LINKFLAGS) -o $@
...
test-engine-metal: $(TEST_METAL_TARGETS)
	...
	$(METAL_TEST_ENV) $(TEST_ACCEPT_ORACLE_TEST) $(LIB)
